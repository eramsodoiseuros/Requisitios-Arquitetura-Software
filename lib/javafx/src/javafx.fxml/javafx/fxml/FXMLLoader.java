...
public class FXMLLoader {
        ...
        private void processObservableListHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                ...
                if (handler != null) {
                    ...
                    throw constructLoadException("PL.Controller method \"" + handlerValue + "\" not found.");
                }
        ...
        public void processAttribute(String prefix, String localName, String value)
            ...
            if (prefix != null
                ...
                if (localName.equals(FX_ID_ATTRIBUTE)) {
                    ...
                    if (controller != null) {
                        throw constructLoadException("PL.Controller value already specified.");
                    }
     ...
     * @since JavaFX 2.2
     */
    public static final String CONTROLLER_SUFFIX = "PL.Controller";
